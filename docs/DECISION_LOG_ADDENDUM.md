...
Both migrations (`20260818140000_cross_training_crew_duration_height.sql`, `20260818150000_crew_heart_rate.sql`) were written and reasoned about statically; neither had been applied to any project or verified against a live Postgres as of this decision, for the same reason D-077 records — no Docker in the environment this was built in.
